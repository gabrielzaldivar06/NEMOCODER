...
| --- | --- | --- | --- | --- | --- |
| FR1 Desktop App Shell | aligned | docs/specs/desktop-product-contract.md, docs/specs/desktop-ui-flows.md | tests/test_desktop_product_contract.py, tests/test_desktop_ui_flows_contract.py, tests/test_desktop_release_readiness_contract.py | src/nemo_coding_platform/core/product.py:61, src/nemo_coding_platform/mission_control_server.py:999, apps/nemo-desktop/src-tauri/src/main.rs:364 | none |
...
- docs/specs/non-functional-contracts.md
- docs/specs/data-model-contracts.md
...
- RC packaging baseline defined and automated:
	...
	- generated outputs include `manifest.json`, `integrity.json`, and `release-checklist.md` in `.release/space-code-<bundle-version>/`
...
- Real MCP continuity release gate is available for local/release dispatch:
	- set `SPACE_CODE_REAL_MCP_REQUIRED=1` or workflow dispatch `real_mcp_gate=true`
...
- `set SPACE_CODE_REAL_MCP_REQUIRED=1 && python -m unittest tests.test_mission_control_server.MissionControlServerTests.test_mcp_native_real_server_continuity_across_sessions_and_core_tools`
