...
class CiWorkflowContractTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.workflow = self.repo_root / ".github" / "workflows" / "space-code-ci.yml"
    ...
    def test_real_mcp_release_gate_is_opt_in_and_required_when_enabled(self) -> None:
        self.assertIn("SPACE_CODE_REAL_MCP_REQUIRED:", self.source)
        self.assertIn("vars.SPACE_CODE_REAL_MCP_REQUIRED", self.source)
