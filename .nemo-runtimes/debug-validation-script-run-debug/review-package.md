...
command=C:\dev\dev4\.venv\Scripts\python.exe validation_script_1.py
status=failed
returncode=2
output:
C:\dev\dev4\.venv\Scripts\python.exe: can't open file 'C:\\dev\\dev4\\validation_script_1.py': [Errno 2] No such file or directory
